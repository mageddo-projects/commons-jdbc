...
import com.mageddo.commons.jdbc.internals.utils.ObjectUtils;
import com.mageddo.commons.jdbc.internals.utils.StringUtils;
...
public class SqlErrorCodes {
  ...
  private static Properties loadSqlErrorsProperties() {
    try {
      ...
      loadIfNotNull(properties, "/com/mageddo/commons/jdbc/db/sql-error-codes.properties");
      loadIfNotNull(properties, "/com/mageddo/commons/jdbc/db/sql-error-codes-override.properties");
      return properties;
    } catch (IOException e) {
